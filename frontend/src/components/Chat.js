  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        <main style={{marginTop:"4.6 rem"}}>
            <h1 style={{ fontWeight: 800, fontSize: '33px',marginBottom:"47px",textAlign:"center"}}>ChatSection Rooms</h1>
            <div className={styles.subjects} style={{display: 'inline-block', width: '18rem', textAlign: 'left',marginLeft:"100px"}}>
              <div className="card-body">
                <h5 className="card-title">Name</h5>
                <Link  to="/chat/chatroom">
                    <a className={styles.enter} href="#">
                      
                      <h2 className="card-text">Go to Chat</h2>
                      <FiMonitor className={styles.entericon}/>
                    </a>
